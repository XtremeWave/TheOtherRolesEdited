...
namespace TheOtherRolesEdited
{
    public static class SubmergedCompatibility
    {
        ...
        public static bool TryLoadSubmerged()
        {
            try
            {
                TheOtherRolesEditedPlugin.Logger.LogMessage("Trying to load Submerged...");
            ...
            {
                TheOtherRolesEditedPlugin.Logger.LogError(e);
            }
            return false;
        }
        ...
        public static void RepairOxygen() {
            ...
            try {
                ...
                TheOtherRolesEditedPlugin.Logger.LogMessage("null reference in engineer oxygen fix");
            }
