...
{   
    ...
    static void LoadButtons(MainMenuManager __instance)
    {
        ...
        CreateButton(__instance, template, GameObject.Find("RightPanel")?.transform, new(0.4f, 0.02f),"GitHub", () => { Application.OpenURL("https://github.com/XtremeWave/TheOtherRolesEdited"); }, Color.blue);
        CreateButton(__instance, template, GameObject.Find("RightPanel")?.transform, new(0.2f, 0.02f), "方块の小站", () => { Application.OpenURL("https://fangkuai.fun"); }, Color.blue);
    }
