    ...
    public static class HatsTab_OnEnable
    {
        ...
        private static void CreateNavButtons(HatsTab tab)
        {
            ...
            if (titleTransform != null)
            {
                ...
                titleTransform.localPosition = new Vector3(1.7f, -0.2f, pos.z);
            }
            ...
            bool flip)
        {
            ...
            btn.OnClick.AddListener((Action)(() => { onClick.Invoke(); PlaySelectSE(); }));
            btn.OnMouseOver.AddListener((Action)(() => { sr.sprite = arrowSpriteActive; PlayHoverSE(); }));
