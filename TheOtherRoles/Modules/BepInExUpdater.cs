...
public class BepInExUpdater : MonoBehaviour
{
    ...
    public void Awake()
    {
        TheOtherRolesEditedPlugin.Logger.LogMessage("BepInEx Update Required...");
        TheOtherRolesEditedPlugin.Logger.LogMessage($"{Paths.BepInExVersion}, {RequiredBepInExVersion} ");
