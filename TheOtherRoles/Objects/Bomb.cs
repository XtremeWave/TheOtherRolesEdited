...
namespace TheOtherRolesEdited.Objects {
    public class Bomb {
        ...
        public static Sprite getBombSprite() {
            ...
            bombSprite = Helpers.loadSpriteFromResources("TheOtherRolesEdited.Resources.Bomb.png", 300f);
            return bombSprite;
        }
        public static Sprite getBackgroundSprite() {
            if (backgroundSprite) return backgroundSprite;
            backgroundSprite = Helpers.loadSpriteFromResources("TheOtherRolesEdited.Resources.BombBackground.png", 110f / Bomber.hearRange);
            return backgroundSprite;
        }

        public static Sprite getDefuseSprite() {
            if (defuseSprite) return defuseSprite;
            defuseSprite = Helpers.loadSpriteFromResources("TheOtherRolesEdited.Resources.Bomb_Button_Defuse.png", 115f);
            return defuseSprite;
        }
