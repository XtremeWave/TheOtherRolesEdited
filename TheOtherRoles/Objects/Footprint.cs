...
namespace TheOtherRolesEdited.Objects 
{
    public class FootprintHolder : MonoBehaviour {
        ...
        private static Sprite FootprintSprite => _footprintSprite ??= Helpers.loadSpriteFromResources("TheOtherRolesEdited.Resources.Footprint.png", 600f);

        private static bool AnonymousFootprints => TheOtherRolesEdited.Detective.anonymousFootprints;
        private static float FootprintDuration => TheOtherRolesEdited.Detective.footprintDuration;
