...
namespace TheOtherRolesEdited
{
    ...
    public static void HandleShareOptions(byte numberOfOptions, MessageReader reader) {            
        ...
        public static void disperse()
        {
            ...
            {
                new Vector3(-16.7f, 5.35f, 0.0f), //食堂
                new Vector3(-22.2f, 1.14f, 0.0f),//海滩边
                new Vector3(-15.54f, 0.23f, 0.0f),//水花区
                new Vector3(-16.93f, -2.46f, 0.0f),//水花区内管道
                new Vector3(-0.98f, 0.46f, 0.0f),//火炉下方
                new Vector3(2.06f, 4.55f, 0.0f),//库房
                new Vector3(2.79f, 1.11f, 0.0f),//库房下的管道
                new Vector3(-1.88f, -1.3f, 0.0f),//会议厅
                new Vector3(-1.69f, -1.69f, 0.0f),//宿舍
                new Vector3(22.26f, 14.07f, 0.0f),//通信室
                new Vector3(21.54f, 10.7f, 0.0f),//楼梯一上的平台
                new Vector3(19.14f, 7.12f, 0.0f),//楼梯二上的平台
                new Vector3(18.05f, 0.07f, 0.0f),//楼梯三上的平台
                new Vector3(23.1f, -7.18f, 0.0f),//核反应堆
                new Vector3(9.12f, -11.99f, 0.0f),//温室下
                new Vector3(9.12f, -9.9f, 0.0f),//温室上
                new Vector3(-2.96f, -10.32f, 0.0f),//实验室
                new Vector3(7.58f, 0.72f, 0.0f),//瞭望台
                new Vector3(-22.98f, -7.26f, 0.0f),//码头
                new Vector3(-17.31f, -9.1f, 0.0f),//厨房
            };
            List<Vector3> submergedSpawn = new List<Vector3>()
            {
                new Vector3(-3.44f, -34.72f, 0.0f), //监控室
            };
            ...
            if (AntiTeleport.antiTeleport.FindAll(x => x.PlayerId == CachedPlayer.LocalPlayer.PlayerControl.PlayerId).Count == 0 && !CachedPlayer.LocalPlayer.Data.IsDead)
            {
                foreach (PlayerControl player in CachedPlayer.AllPlayers)
                {
                    ...
                    if (GameOptionsManager.Instance.currentNormalGameOptions.MapId == 6) CachedPlayer.LocalPlayer.PlayerControl.transform.position = submergedSpawn[rnd.Next(submergedSpawn.Count)];
                }
        ...
        public static void guesserShoot(byte killerId, byte dyingTargetId, byte guessedTargetId, byte guessedRoleId) {
            ...
            if (PlayerControl.LocalPlayer.Data.IsDead && guessedTarget != null && guesser != null) {
                RoleInfo roleInfo = RoleInfo.allRoleInfos.FirstOrDefault(x => (byte)x.roleId == guessedRoleId);
                string msg = $"{guesser.Data.PlayerName}赌杀{guessedTarget.Data.PlayerName}的职业为{roleInfo?.name ?? ""}!";
