...
namespace TheOtherRolesEdited.CustomGameModes {
    [HarmonyPatch]
    class PropHunt {
        ...
        public static void poolablePlayerUpdate() {
            if (poolablesBackground == null) {
                ...
                if (poolablesBackgroundSprite == null) poolablesBackgroundSprite = Helpers.loadSpriteFromResources("TheOtherRolesEdited.Resources.poolablesBackground.jpg", 200f);
            }
        ...
        public static Sprite getDisguiseButtonSprite() {
            ...
            disguiseButtonSprite = Helpers.loadSpriteFromResources("TheOtherRolesEdited.Resources.DisguiseButton.png", 115f);
            return disguiseButtonSprite;
        }

        public static Sprite getUnstuckButtonSprite() {
            if (unstuckButtonSprite) return unstuckButtonSprite;
            unstuckButtonSprite = Helpers.loadSpriteFromResources("TheOtherRolesEdited.Resources.UnStuck.png", 115f);
            return unstuckButtonSprite;
        }
        public static Sprite getRevealButtonSprite() {
            if (revealButtonSprite) return revealButtonSprite;
            revealButtonSprite = Helpers.loadSpriteFromResources("TheOtherRolesEdited.Resources.Reveal.png", 115f);
            return revealButtonSprite;
        }

        public static Sprite getInvisButtonSprite() {
            if (invisButtonSprite) return invisButtonSprite;
            invisButtonSprite = Helpers.loadSpriteFromResources("TheOtherRolesEdited.Resources.InvisButton.png", 115f);
            return invisButtonSprite;
        }

        public static Sprite getFindButtonSprite() {
            if (findButtonSprite) return findButtonSprite;
            findButtonSprite = Helpers.loadSpriteFromResources("TheOtherRolesEdited.Resources.FindButton.png", 115f);
        ...
        public static Sprite getSpeedboostButtonSprite() {
            ...
            speedboostButtonSprite = Helpers.loadSpriteFromResources("TheOtherRolesEdited.Resources.SpeedboostButton.png", 115f);
        ...
        public static GameObject FindClosestDisguiseObject(GameObject origin, float radius, bool verbose=false) {
            ...
            try {
                ...
                foreach (Collider2D collider in Physics2D.OverlapCircleAll(origin.transform.position, radius)) {
                    if (verbose) {
                        TheOtherRolesEditedPlugin.Logger.LogMessage($"Nearby Object: {collider.gameObject.name}");
                    }
                    bool whiteListed = false;
            ...
            {
                TheOtherRolesEditedPlugin.Logger.LogError($"Error in find closest disguise object: {e}");
                return null;
            }
        }
