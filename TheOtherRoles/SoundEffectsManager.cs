...
namespace TheOtherRolesEdited
{
...

    {
        ...
        public static void playAtPosition(string path, Vector2 position, float maxDuration = 15f, float range = 5f, bool loop = false)
        {
            ...
            AudioClip clipToPlay = get(path);
            TheOtherRolesEditedPlugin.Logger.LogMessage("play at  position");
            if (clipToPlay == null)
            {
                TheOtherRolesEditedPlugin.Logger.LogMessage("clip is null");
                return;
            }
            ...
            TheOtherRolesEditedPlugin.Logger.LogMessage("end play at position");
        }
        ...
        public static void stop(string path)
        {
            ...
            if (soundToStop != null)
            {
                ...
                catch (Exception e) { TheOtherRolesEditedPlugin.Logger.LogWarning($"Exception in stop sound: {e}"); }
            }
        }
