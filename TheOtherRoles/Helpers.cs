...
namespace TheOtherRolesEdited {
    ...
    public static class ColorHelper
    {
        ...
        public const string ModColor = "#2E8EFB";
        ...
        public static readonly Color32 HalfYellow = new(255, 234, 115, 255);
        public static readonly Color32 HalfModColor32 = new(13, 96, 250, 160);
        public static readonly Color32 FaultColor = new(171, 195, 251, 255);
    ...
    public static class Helpers {  
        ...
        public static string GradientColorText(string startColorHex, string endColorHex, string text)
        {
            ...
            {
                TheOtherRolesEditedPlugin.Logger.LogError("GradientColorText : Invalid Color Hex Code, Hex code should be 6 characters long (without #) (e.g., FFFFFF).");
                return text;
            }
        ...
        public static void enableCursor(bool initalSetCursor)
        {
            ...
            if (TheOtherRolesEditedPlugin.ToggleCursor.Value)
            {
        ...
        public static void toggleZoom(bool reset=false) {
            ...
            if (tzGO != null) {
                ...
                rend.sprite = zoomOutStatus ? Helpers.loadSpriteFromResources("TheOtherRolesEdited.Resources.Plus_Button.png", 100f) : Helpers.loadSpriteFromResources("TheOtherRolesEdited.Resources.Minus_Button.png", 100f);
                rendActive.sprite = zoomOutStatus ? Helpers.loadSpriteFromResources("TheOtherRolesEdited.Resources.Plus_ButtonActive.png", 100f) : Helpers.loadSpriteFromResources("TheOtherRolesEdited.Resources.Minus_ButtonActive.png", 100f);
        ...
        public static async Task checkBeta() {
            if (TheOtherRolesEditedPlugin.betaDays > 0) {
                ...
                if ((now - compileTime)?.TotalDays > TheOtherRolesEditedPlugin.betaDays) {
                    ...
                    BepInExUpdater.MessageBoxTimeout(BepInExUpdater.GetForegroundWindow(), "测试时间已到,无法在次测试版本游玩.", "The Other Roles Edited Beta", 0,0, 10000);
                    Application.Quit();
