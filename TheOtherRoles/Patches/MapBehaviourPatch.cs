...
namespace TheOtherRolesEdited.Patches {
	...
	static class MapBehaviourPatch {
		...
		public static Sprite Vent = Helpers.loadSpriteFromResources("TheOtherRolesEdited.Resources.Vent.png", 150f);
		...
		static void Postfix(MapBehaviour __instance) {
			...
			foreach (var vent in MapUtilities.CachedShipStatus.AllVents) {
				...
				if (!TheOtherRolesEditedPlugin.ShowVentsOnMap.Value) {
					if (mapIcons.Count > 0) {
