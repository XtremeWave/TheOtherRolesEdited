...
public class EnterCodePatch
{
    ...
    public static void OnEnable_Postfix(EnterCodeManager __instance)
    {
        ...
        if (ifFirst)
        {
            FieldsContainer.transform.localScale = new Vector3(0.85f, 0.85f, 0f);
            EnterCodeField.transform.localPosition = new Vector3(0.2559f, 1.7178f, 0f);
            JoinGameButton.transform.localPosition = new Vector3(0.263f, -1.48f, 0f);
            JoinGameButton.transform.localScale = new Vector3(0.95f, 0.95f, 0f);
            MapShow = Object.Instantiate(Chat.gameObject, Chat.parent);
            MapShow.gameObject.name = "Map";
            MapShow.transform.localPosition -= new Vector3(0f, 0.564f, 0f);
            ...
            titletmp.text = ModTranslation.getString("Map");
    ...
    public static void FindGameResult_Postfix(EnterCodeManager __instance)
    {
        ...
        Sprite_sprite.sprite = Helpers.loadSpriteFromResources($"TheOtherRolesEdited.Resources.MapsImages.{mapNameText}.png", 300f);
