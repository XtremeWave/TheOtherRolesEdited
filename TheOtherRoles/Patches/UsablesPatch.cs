...
namespace TheOtherRolesEdited.Patches {
    ...
    class EmergencyMinigameUpdatePatch {
        static void Postfix(EmergencyMinigame __instance) {
            ...
            if (Lawyer.lawyer != null && Lawyer.lawyer == PlayerControl.LocalPlayer && !Lawyer.canCallEmergency) {
                roleCanCallEmergency = false;
                statusText = "律师不能开启紧急会议!";
                if (Lawyer.isProsecutor) statusText = "起诉人不能开启紧急会议!";
            }
            ...
            if (__instance.state == 1) {
                ...
                __instance.NumberText.text = $"{localRemaining.ToString()}次  全员还剩{teamRemaining.ToString()}次";
    ...
    class SurveillanceMinigamePatch {
        ...
        private static Sprite overlaySprite = Helpers.loadSpriteFromResources("TheOtherRolesEdited.Resources.NightVisionOverlay.png", 350f);
