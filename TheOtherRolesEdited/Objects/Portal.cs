    ...
    public class Portal {
        ...
        public static Sprite getFgAnimationSprite(int index) {
            ...
            if (portalFgAnimationSprites[index] == null)
                portalFgAnimationSprites[index] = (Helpers.loadSpriteFromResources($"TheOtherRolesEdited.Resources.PortalAnimation.portal_{(index):000}.png", 115f));
        ...
        public Portal(Vector2 p) {
            ...
            bool playerIsPortalmaker = PlayerControl.LocalPlayer == TheOtherRolesEdited.Portalmaker.portalmaker;
        ...
        private static void preloadSprites() {
            ...
            portalSprite = Helpers.loadSpriteFromResources("TheOtherRolesEdited.Resources.PortalAnimation.plattform.png", 115f);
        }
