...
namespace TheOtherRolesEdited.CustomGameModes {
    ...
    public static class Hunter {
        ...
        public static Sprite getArrowSprite() {
            ...
            buttonSpriteArrow = Helpers.loadSpriteFromResources("TheOtherRolesEdited.Resources.HideNSeekArrowButton.png", 115f);
            return buttonSpriteArrow;
        }

        public static Sprite getLightSprite() {
            if (buttonSpriteLight) return buttonSpriteLight;
            buttonSpriteLight = Helpers.loadSpriteFromResources("TheOtherRolesEdited.Resources.LighterButton.png", 115f);
