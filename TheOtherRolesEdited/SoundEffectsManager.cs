...
namespace TheOtherRolesEdited
{
        ...
        
    {
        ...
        public static void Load()
        {
            ...
            {
                if (resourceName.Contains("TheOtherRolesEdited.Resources.SoundEffects.") && (resourceName.Contains(".raw") || resourceName.Contains(".ogg")))
                {
        ...
        public static AudioClip get(string path)
        {
            ...
            //if (!path.Contains(".")) path = "TheOtherRolesEdited.Resources.SoundEffects." + path + ".raw";
